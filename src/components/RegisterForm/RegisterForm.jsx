      ...
      <div className='register-block__card'>
        ...
        <form action="#" className='register-block__form' id='register-form' onSubmit={onSubmit}>
          ...
          <MyInput 
            ...
            value={values.name || ''}
          />
          <span className={`register-block__error ${errors.name ? 'register-block__error_active' : ''}`}>{errors.name}</span>
          ...
          <MyInput 
            ...
            value={values.social || ''}
          />
          <span className={`register-block__error ${errors.social ? 'register-block__error' : ''}`}>{errors.social}</span>
          ...
          <MyInput 
            ...
            value={values.email || ''}
          />
          <span className={`register-block__error ${errors.email ? 'register-block__error_active' : ''}`}>{errors.email}</span>
          ...
          <MyInput 
            ...
            value={values.number || ''}
          />
          <span className={`register-block__error ${errors.number ? 'register-block__error_active' : ''}`}>{errors.number}</span>
        <button className={`register-block__btn ${!isValid ? 'register-block__btn_disable' : '' }`} type='submit' disabled={!isValid}>Оставить заявку</button>
        </form>
        <ModalToolTip 
